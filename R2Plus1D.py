...
class R2Plus1DNet(nn.Module):
    ...
    def __init__(self, layer_sizes, block_type=SpatioTemporalResBlock):
        ...
        self.conv1 = SpatioTemporalConv(5, 64, (1, 7, 7), stride=(1, 2, 2), padding=(0, 3, 3), first_conv=True)
...
if __name__ == "__main__":
    import torch
    inputs = torch.rand(1, 3, 16, 64, 128).cuda()
    net = R2Plus1DClassifier(7, (2, 2, 2, 2), pretrained=False).cuda()
    outputs = net.forward(inputs)
    print(outputs.size())
#    import hiddenlayer as hl
#    hlGraph = hl.build_graph(net,inputs)
